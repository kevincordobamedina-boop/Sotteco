                ...
                <div class="site-header-shown">
                    ...
                    <div class="dropdown user-menu">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                            ...
                            <!--<a class="dropdown-item"  href="../MainHeader/MANUAL DE USUARIO SOTTECO.docx" download class="download-btn" download="Nombre_Descarga.docx" class="boton-descarga"><span class="font-icon glyphicon glyphicon-question-sign"></span>Ayuda</a>-->
                            <a class="dropdown-item"  href="/manual_usuasio/MANUAL DE USUARIO SOTTECO.pdf" target="_blank" ><span class="font-icon glyphicon glyphicon-question-sign"></span>Ayuda</a>
