...
<html>
	...
	<title>SOTTECO  Nueva orden de trabajo</title>
</head>
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<p>
					Desde esta ventana podra generar nuevas orden de trabajo .<br>
					(*) Datos Obligatorios
				</p>
					...
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-12">
							<fieldset class="form-group">
								...
								<input type="text" class="form-control" id="tick_titulo" name="tick_titulo" placeholder="Ingrese nombre" required>
							</fieldset>
						</div>
