...
?>
  ...
  <title>Sotteco Detalle orden</title>
  </head>
      ...
      <div class="container-fluid">
        ...
        <header class="section-header">
          <div class="tbl">
            <div class="tbl-row">
              <div class="tbl-cell">
                <h3 id="lblnomidticket">Detalle orden de trabajo - 1</h3>
                <div id="lblestado"></div>
                <span class="label label-pill label-primary" id="lblnomusuario"></span>
                <span class="label label-pill label-default" id="lblfechcrea"></span>
                <ol class="breadcrumb breadcrumb-simple">
                  <li><a href="#">Inicio</a></li>
                  <li class="active">Detalle orden de trabajo</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset class="form-group">
                  <label class="form-label semibold" for="tick_titulo">Nombre del cliente</label>
        ...
        <div class="box-typical box-typical-padding" id="pnldetalle">
          <p>
            Ingrese su retroalimentacion de la orden de trabajo
          </p>
          <div class="row">
              <div class="col-lg-12">
                <fieldset class="form-group">
           ...
           <!--    <?php
                  //if($_SESSION["rol_id"]==2){
                    ?>
                      <button type="button" id="btnchatgpt" class="btn btn-rounded btn-inline btn-success">Anular</button>
               //     <?php
              //    }
                ?>-->

                <button type="button" id="btncerrarticket" class="btn btn-rounded btn-inline btn-warning">Cerrar orden de trabajo</button>
              </div>
          </div>
			  </div>
