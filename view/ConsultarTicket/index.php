...
<html>
	...
	<title>Sotteco Consultar Ticket</title>
</head>
					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li class="active">Consultar orden de trabajo</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row" id="viewuser">
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" for="tick_titulo">Nombre cliente</label>
							<input type="text" class="form-control" id="tick_titulo" name="tick_titulo" placeholder="Ingrese nombre de cliente" required>
						</fieldset>
					</div>
					...
					<table id="ticket_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
								...
								<th class="d-none d-sm-table-cell" style="width: 30%;">Nombre de cliente</th>
