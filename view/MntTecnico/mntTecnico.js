...
function editar(usu_id){
    ...
    $.post("../../controller/tecnico.php?op=mostrar", {usu_id : usu_id}, function (data) {
        console.log(data);
...
function eliminar(usu_id){
    swal({
        title: "",
        text: "Esta seguro de Eliminar al tecnico?",
        type: "error",
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.post("../../controller/tecnico.php?op=eliminar", {usu_id : usu_id}, function (data) {
