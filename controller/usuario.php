    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                if ($row["rol_id"]=="1"){
                    $sub_array[] = '<span class="label label-pill label-success">Supervisor</span>';
                //}if ($row["rol_id"]=="2"){
        ...
        case "totalcerrado";
            ...
            break;
                                            ...
                                            /* TODO: Cantidad de Ticket anulados por Usuario en formato JSON */
              case "totalanulado";
            $datos=$usuario->get_usuario_totalanulado_x_id($_POST["usu_id"]);  
            if(is_array($datos)==true and count($datos)>0){
                foreach($datos as $row)
                {
                    $output["TOTAL"] = $row["TOTAL"];
