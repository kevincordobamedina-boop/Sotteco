...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'kevincordobamedina@gmail.com';
    protected $gContrasena = 'poriyrbrwkmnqmdx';
    ...
    public function ticket_abierto($tick_id){
        ...
        $cuerpo = str_replace("lblDescrip", $descripcion, $cuerpo);
    ...
    public function ticket_comentario($tick_id){
        ...
        //Igual//
        $cuerpo = file_get_contents('../public/ComentarioTicket.html'); /*TODO:  Ruta del template en formato HTML */
        /*TODO:  parametros del template a remplazar */
        $cuerpo = str_replace("xnroticket", $id, $cuerpo);
        $cuerpo = str_replace("lblNomUsu", $usu, $cuerpo);
        $cuerpo = str_replace("lblTitu", $titulo, $cuerpo);
        ...
        try{
            ...
            public function ticket_agendada($tick_id){
        $ticket = new Ticket();
        $datos = $ticket->listar_ticket_x_id($tick_id);
        foreach ($datos as $row){
            $id = $row["tick_id"];
        ...
        $this->WordWrap = 50;
        $this->IsHTML(true);
        $this->Subject = "Ticket agendada";
        //Igual//
        $cuerpo = file_get_contents('../public/Ticket agendada.html'); /*TODO:  Ruta del template en formato HTML */
        /*TODO:  parametros del template a remplazar */
        $cuerpo = str_replace("xnroticket", $id, $cuerpo);
        $cuerpo = str_replace("lblNomUsu", $usu, $cuerpo);
        $cuerpo = str_replace("lblTitu", $titulo, $cuerpo);
