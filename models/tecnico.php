<?php
    class tecnico extends Conectar{
        ...
        public function login(){
            ...
            if(isset($_POST["enviar"])){
                ...
                if(empty($correo) and empty($pass)){
                    ...
                    $sql = "SELECT * FROM tm_tecnico WHERE usu_correo=? and rol_id=? and est=1";
        ...
        /* TODO:Insert */
        public function insert_tecnico($usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf){
         ...
         /*   $key="mi_key_secret";
            ...
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_tecnico (usu_id, usu_nom, usu_ape, usu_correo, usu_pass, rol_id, usu_telf, fech_crea, fech_modi, fech_elim, est) 
        ...
        /* TODO:Update */
        public function update_tecnico($usu_id,$usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf){
        ...
        /* TODO:Delete */
        public function delete_tecnico($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        /* TODO:Todos los registros de los tecnicos*/
        ...
        /* TODO: Obtener registros de tecnicos segun rol 2 */
        public function get_tecnico_x_rol(){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT * FROM tm_tecnico where est=1 and rol_id=2";
            $sql=$conectar->prepare($sql);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        }
        ...
        public function get_tecnico_x_id($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function get_tecnico_total_x_id($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function get_tecnico_totalabierto_x_id($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function get_tecnico_totalcerrado_x_id($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function get_tecnico_grafico($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function update_tecnico_pass($usu_id,$usu_pass){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="UPDATE tm_tecnico
                SET
                    usu_pass = ?
                WHERE
                    usu_id = ?";
        ...
        public function get_tecnico_x_correo($usu_correo){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT * FROM tm_tecnico WHERE usu_correo=?";
            $sql=$conectar->prepare($sql);
