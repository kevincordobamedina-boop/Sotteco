<?php
    class Ticket extends Conectar{
        ...
        /* TODO: Mostrar detalle de ticket por id de ticket */    /* COMENTARIOS DE ADMIN */
        ...
        public function insert_ticketdetalle($tick_id,$usu_id,$tickd_descrip){
            ...
            /* TODO: si Rol es 1 = Usuario insertar alerta para usuario soporte */   /* COMENTARIO ACTIVADO000000 */
        ...
        public function insert_ticketdetalle_cerrar($tick_id,$usu_id){
            ...
            return $resultado=$sql->fetchAll();
                                     ...
                                     /* TODO: Insertar linea adicional de detalle al anular el ticket */
        public function insert_ticketdetalle_anulado($tick_id,$usu_id){
            $conectar= parent::conexion();
            parent::set_names();
                $sql="call sp_i_ticketdetalle_01(?,?)";
            $sql=$conectar->prepare($sql);
        ...
        public function update_ticket($tick_id){
          ...
          /* Actualizar estado a anulado*/                        /* actualizar ticket */
        public function update_ticket_anulado($tick_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="update tm_ticket 
                set	
        ...
        public function get_ticket_totalcerrado(){
         ...
         /* TODO: Total de ticket anulados */                      /*  Total de ticket anulados */
        public function get_ticket_totalanulado(){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT COUNT(*) as TOTAL FROM tm_ticket where tick_estado='anulado'";
            $sql=$conectar->prepare($sql);
            $sql->execute();
            return $resultado=$sql->fetchAll();
        } 
