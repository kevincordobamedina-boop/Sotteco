<?php
    class Usuario extends Conectar{
        ...
        public function get_usuario_totalcerrado_x_id($usu_id){
          ...
          /* TODO: Total de Tickets anulados por usu_id */                        /* TODO: Total de Tickets anulados por usu_id */             

        public function get_usuario_totalanulado_x_id($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT COUNT(*) as TOTAL FROM tm_ticket where usu_id = ? and tick_estado='anulado'";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $usu_id);
            $sql->execute();
            return $resultado=$sql->fetchAll();
